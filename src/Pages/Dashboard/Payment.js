...
const stripePromise = loadStripe(
  "pk_test_51L1lwNK8cblwyB4icoDXqCV5LRsqz0BUpH0hPggBa0b10LucJ4r91UIcNBp0DBWqe94yOFFslBJmqMDKdZNesRZ400Ewz7t6jX"
);
const Payment = () => {
  const { id } = useParams();
  const { data: order, isLoading } = useQuery(["order", id], () =>
    fetch(`https://wooden-tools.onrender.com/orders/order/${id}`, {
      method: "GET",
      headers: {
