...
import woodenBanner from '../../images/banner/banner-2.png'
    ...
    return (
        <div className="hero py-32" style={{
            ...
            <div className="hero-content text-center text-neutral-content">
                <div className="w-1/2">
                    <h1 className="mb-5 text-3xl lg:text-5xl font-bold text-primary drop-shadow-2xl tracking-wider">wooden Hand Tools</h1>
